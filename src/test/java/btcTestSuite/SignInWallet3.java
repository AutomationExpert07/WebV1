...
public class SignInWallet3 extends TestBase{
	public static final Logger log= Logger.getLogger(SignInWallet3.class.getName());
	...
	//TC objective Verify the calculation of the Bitcoin when a trancation is made.
		...
		@Test(priority=10)
		public void trasactionVerify1234() throws InterruptedException 
		{
			homePage.SelectBTC();
